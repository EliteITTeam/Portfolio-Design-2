...
import "./Home.scss";
import { HdImg, Pcrd1, Pcrd2, Pcrd3, sendpay, Ecom, Blean } from "../../assets";
  ...
  return (
    <>
      ...
      <div className="mp-container">
        <div className="mp-container-content">
          <div className="mp-container-content-one">
            <h1>
              My <b>Portfolio </b>
            </h1>
          </div>
          <div className="mp-container-content-two">
            <img src={sendpay} alt="asdf" />
            <img src={Ecom} alt="asdf" />
            <img src={Blean} alt="asdf" />
          </div>
        </div>
      </div>
    </>
